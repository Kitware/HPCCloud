...
LOCAL_DIRECTORY = '/hpccloud/pvw-dependencies/pv-lite'
...
MAIN_SCRIPT = 'pvw-lite.py'

# -----------------------------------------------------------------------------
# ParaView Lite TaskFlow
# -----------------------------------------------------------------------------

class ParaViewLiteTaskFlow(cumulus.taskflow.cluster.ClusterProvisioningTaskFlow):
    """
    {
    ...
    def start(self, *args, **kwargs):
        ...
        super(ParaViewLiteTaskFlow, self).start(self, *args, **kwargs)

    def terminate(self):
        super(ParaViewLiteTaskFlow, self).terminate()
        self.run_task(cleanup_proxy_entries.s())

    def delete(self):
        super(ParaViewLiteTaskFlow, self).delete()
        self.run_task(cleanup_proxy_entries.s())

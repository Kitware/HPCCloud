...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = global["Simput"]["types"]["nwchem"] = __webpack_require__(1);
		...
		"attributes": {
			"calculationSettings": {
				...
				"parameters": {
					...
					"settings.type": "Calculation Type",
					"settings.theory_base": "Theory",
					"settings.theory_basis": "Basis",
	...
	module.exports = function (model) {
	    ...
	    switch (theory) {
	        ...
	        case 'dft':
	            ...
	            templateData.data.theory = ['dft', '  xc b3lyp', '  mult ' + mult].join('\n');
	            break;
	        case 'mp2':
	            templateData.data.theory = ['mp2', '  # Exclude core electrons from MP2 treatment', '  freeze atomic'].join('\n');
	            break;
	        case 'ccsd':
	            templateData.data.theory = ['ccsd', '  # Exclude core electrons from MP2 treatment', '  freeze atomic'].join('\n');
	            break;
	        default:
	            break;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return container.escapeExpression(((helper = (helper = helpers.theory || (depth0 != null ? depth0.theory : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"theory","hash":{},"data":data}) : helper)))
	    + "\n";
	  ...
	  return "echo\n\nstart molecule\n\ntitle \""
	    ...
	    + "\nend\n\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.theory : depth0),{"name":"if","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "\ntask "
	    + alias4(((helper = (helper = helpers.theory_type || (depth0 != null ? depth0.theory_type : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"theory_type","hash":{},"data":data}) : helper)))
	    + " "
	    + alias4(((helper = (helper = helpers.calculation_type || (depth0 != null ? depth0.calculation_type : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"calculation_type","hash":{},"data":data}) : helper)))
	    + "\n";
	},"useData":true});

...
import { ProjectHelper, SimulationHelper } from '../../../utils/AccessHelper';
  ...
  render() {
    return (
      <TableListing
        ...
        title={ <span> <img src={ProjectHelper.getIcon(this.props.project).image} height="20px" /> {this.props.project.name} / Simulations</span> }
        placeholder={

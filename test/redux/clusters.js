...
describe('cluster actions', () => {
  ...
  describe('simple actions', () => {
    it('should add an empty cluster', (done) => {
      ...
      expect(Actions.addCluster()).toDispatchActions(
        expectedAction,
        complete(done)
      );
    ...
    it('should apply cluster preset', (done) => {
      const expectedAction = {
        type: Actions.CLUSTER_APPLY_PRESET,
        index: 0,
        name: 'myCluster',
      };
      expect(Actions.applyPreset(0, 'myCluster')).toDispatchActions(
        expectedAction,
        complete(done)
      );
    ...
    it('should remove cluster given an id', (done) => {
      const expectedAction = {
        type: Actions.REMOVE_CLUSTER_BY_ID,
        id: cluster._id,
      };
      expect(Actions.removeClusterById(cluster._id)).toDispatchActions(
        expectedAction,
        complete(done)
      );
      ...
      expect(clustersReducer(givenState, expectedAction)).toEqual(
        expectedState
      );
    });
    ...
    it('update the active cluster in a list', (done) => {
      ...
      expect(Actions.updateActiveCluster(index)).toDispatchActions(
        expectedAction,
        complete(done)
      );

      expect(clustersReducer(initialState, expectedAction).active).toEqual(
        index
      );
    });
    ...
    it('update an existing cluster', (done) => {
      ...
      expect(Actions.updateExistingCluster(cluster)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    ...
    it('should update the list of clusters', (done) => {
      ...
      expect(Actions.updateClusters(clusters)).toDispatchActions(
        expectedAction,
        complete(done)
      );
      ...
      expect(clustersReducer(initialState, expectedAction)).toEqual(
        expectedState
      );
    });
    ...
    it('should save a cluster locally', (done) => {
      ...
      expect(Actions.saveCluster(0, cluster, false)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should remove a cluster', (done) => {
      ...
      expect(Actions.removeCluster(0)).toDispatchActions(
        expectedActions,
        complete(done)
      );
    });
    ...
    it('should update cluster presets', (done) => {
      ...
      expect(Actions.updateClusterPresets(presets)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    ...
    it("should update a cluster's log by appending to it", (done) => {
      ...
      const expectedAction = {
        type: Actions.APPEND_TO_CLUSTER_LOG,
        id: cluster._id,
        logEntry,
      };
      expect(
        Actions.appendToClusterLog(cluster._id, logEntry)
    ...
    it("should update a cluster's log with a new log", (done) => {
      ...
      const expectedAction = {
        type: Actions.UPDATE_CLUSTER_LOG,
        id: cluster._id,
        log,
      };
      expect(Actions.updateClusterLog(cluster._id, log)).toDispatchActions(
        expectedAction,
        complete(done)
      );
  ...
  describe('async actions', () => {
    ...
    it('should fetch cluster log', (done) => {
      ...
      expect(Actions.getClusterLog(id)).toDispatchActions(
        { type: Actions.UPDATE_CLUSTER_LOG, id, log },
        complete(done)
      );
    });
    ...
    it('should fetch cluster log with an offset and append', (done) => {
      ...
      setSpy(client, 'getClusterLog', { log });
      expect(Actions.getClusterLog(id, 50)).toDispatchActions(
        { type: Actions.APPEND_TO_CLUSTER_LOG, id, logEntry: log },
        complete(done)
      );
    });
    ...
    it('should fetch a cluster', (done) => {
      ...
      expect(Actions.fetchCluster(expectedAction._id)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should fetch a list of clusters', (done) => {
      ...
      expect(Actions.fetchClusters()).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should delete a cluster', (done) => {
      ...
      expect(Actions.deleteCluster(cluster._id)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should delete a cluster with an id', (done) => {
      ...
      expect(Actions.removeCluster(0, cluster)).toDispatchActions(
        expectedActions,
        complete(done)
      );
    });
    ...
    it('should save a cluster remotely', (done) => {
      ...
      expect(Actions.saveCluster(0, cluster, true)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should update a cluster', (done) => {
      ...
      expect(Actions.updateCluster(cluster)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should not test a cluster without an id', (done) => {
      const expectedAction = {
        type: 'NOOP',
        message: 'Cluster is not available on server yet',
      };
      expect(Actions.testCluster(0, {})).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should test a cluster', (done) => {
      ...
      expect(Actions.testCluster(0, cluster)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });
    ...
    it('should terminate a cluster', (done) => {
      const expectedAction = {
        ...
        id: 'terminate_cluster_a1',
        resp: { data: null },
      };
      setSpy(client, 'terminateCluster', null);
      expect(Actions.terminateCluster(cluster._id)).toDispatchActions(
        expectedAction,
        complete(done)
      );
    });

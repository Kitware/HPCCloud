    ...
    render() {
        ...
        if(this.state.profiles.length === 0) {
            return this.state.busy ? null :
                    <div className={style.subcontainer + ' ' + style.errorBox}>
                        <span>
        ...
        return (
            <div className={style.subcontainer}>
                <section className={style.formItem}>
                    ...
                    <select onChange={this.dataChange} className={style.form}
                        data-key="profile"
                ...
                <section className={style.formItem}>
                    ...
                    <input type="number" min="1" max="100" className={style.form}
                ...
                <section className={style.formItem}>
                    ...
                    <input type="number" min="1" max="16384" className={style.form}

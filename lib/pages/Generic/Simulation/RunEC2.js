        ...
        return (
            <div className={layout.verticalFlexContainer}>
                <section className={form.group}>
                    ...
                    <select onChange={this.dataChange} className={form.input}
                        data-key="profile"
                ...
                <section className={form.group}>
                    <label className={form.label}>Volumne size:</label>
                    <input type="number" min="1" max="16384" className={form.input}

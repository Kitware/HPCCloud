...
import style from './GenericNew.mcss';
            ...
            <div className={ style.container }>
                <div className={ style.titleBar }>
                    <span className={ style.left }>
                        <i className={ 'fa fa-fw fa-arrow-left ' + style.action }  onClick={ this.cancel }></i>
                    </span>
                ...
                <div className={ style.formItem }>
                    ...
                    <input className={ style.form } type='text' value={ this.state.name } data-name='name' onChange={ this.updateForm }/>
                </div>
                <div className={ style.formItem }>
                    <div className={ style.label }> Description </div>
                    <textarea className={ style.form } data-name='description' rows='5' onChange={ this.updateForm } value={this.state.description}/>
                </div>
                { this.props.children }
            </div>);
    },

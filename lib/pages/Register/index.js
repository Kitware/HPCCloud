        ...
        return (
            <center>
                <form className={style.loginForm} onSubmit={this.handleSubmit}>
                    ...
                    <label className={style.loginLabel}>
                        <input ref="login" type="text" placeholder="login" onChange={this.resetError} required/>
                    </label>
                    <label className={style.loginLabel}>
                        <input ref="email" type="email" placeholder="email" onChange={this.resetError} required/>
                    </label>
                    <label className={style.loginLabel}>

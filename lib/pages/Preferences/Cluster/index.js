...
const STATUS_TO_ICON = {
    ...
    creating: 'fa fa-fw fa-medkit lmr',
    created: 'fa fa-fw fa-pencil-square-o lmr',
    running: 'fa fa-fw fa-rocket lmr',
}
...
export default React.createClass({
    ...
    render() {
        ...
        const actions = [{name:'removeItem', label:'Delete', icon:'fa fa-trash-o'}];
        if(activeData){
            actions.push(activeData.config.ssh.publicKey && activeData.status !== 'running'
                ? {name:'testCluster', label:'Test', icon:'fa fa-repeat'}

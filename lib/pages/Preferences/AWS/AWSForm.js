...
import style        from 'HPCCloudStyle/form.css';
            ...
            <div>
                <form onSubmit={(e) => {e.preventDefault()} }>
                    ...
                    <section className={style.group}>
                        ...
                        <input className={style.input} type="text" value={this.state.data.accessKeyId}
                    ...
                    { (this.state.data._id) ? null :
                        <section className={style.group}>
                            ...
                            <input className={style.input} type="password" value={this.state.data.secretAccessKey}
                                data-key="secretAccessKey" onChange={this.formChange} required/>
                        </section>
                    }
                    <section className={style.group}>
                        <label className={style.label}>Region</label>
                        <select className={style.input} value={this.state.data.regionName}
                    ...
                    <section className={style.group}>
                        ...
                        <select className={style.input} value={this.state.data.availabilityZone}
                            data-key="availabilityZone" onChange={this.formChange} required>
                            { this.props.regions[this.state.data.regionName].map( (zone, index) => {
                                return (<option key={zone + '_' + index} value={this.state.data.regionName + zone}>{zone}</option>);
                            }) }
                        </select>
                    </section>
                </form>
